...
var internals = {
    initConfig: function () {
        ...
        internals.config.unpacked = internals.config.unpacked || ".sketch";
        internals.config.export.to = internals.config.export.to || "exports";
        internals.config.export.tool =
            internals.config.export.tool ||
            "/Applications/Sketch.app/Contents/Resources/sketchtool/bin/sketchtool";
        internals.config.export.args = internals.config.export.args || internals.config.export.args || {};
        internals.config.export.args.formats = internals.config.export.args.formats || "svg";
        internals.config.fonts = internals.config.fonts || {};
        internals.config.fonts.embedPrefixes = internals.config.fonts.embedPrefixes || [];
        internals.config.fonts.ignorePrefixes = internals.config.fonts.ignorePrefixes || [];
    ...
    exportContent: function (sketchFilePath, targetDirPath) {
        ...
        return internals.deleteDirAndStage(targetDirPath).then(function () {
            ...
            var command = sketchTool + " export artboards " + sketchFilePath;
